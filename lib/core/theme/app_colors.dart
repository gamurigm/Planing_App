...
class AppColors {
  ...
  static const Color neonTurquoiseShadow = Color(0x5533FFD6); // semi-transparent neon for shadow
  // Strip background: use the same color as the subject title background
  static const Color stripBg = primary;
  // Vertical divider color (black) for cell vertical lines
